/* -*- mode: C -*-  */
/*
   IGraph spectral coarse graining library.
...
IGRAPH_EXPORT igraph_error_t igraph_scg_semiprojectors(const igraph_vector_int_t *groups,
                                                       igraph_scg_matrix_t mtype,
                                                       igraph_matrix_t *L,
                                                       igraph_matrix_t *R,
...
IGRAPH_EXPORT igraph_error_t igraph_scg_norm_eps(const igraph_matrix_t *V,
...
IGRAPH_EXPORT igraph_error_t igraph_scg_adjacency(const igraph_t *graph,
...
IGRAPH_EXPORT igraph_error_t igraph_scg_stochastic(const igraph_t *graph,
                                                   const igraph_matrix_t *matrix,
                                                   const igraph_sparsemat_t *sparsemat,
                                                   const igraph_vector_t *weights,
                                                   const igraph_vector_int_t *ev,
...
IGRAPH_EXPORT igraph_error_t igraph_scg_laplacian(const igraph_t *graph,
                                                  const igraph_matrix_t *matrix,
                                                  const igraph_sparsemat_t *sparsemat,
                                                  const igraph_vector_t *weights,
                                                  const igraph_vector_int_t *ev,
