...
igraph_error_t igraph_i_kmeans_Lloyd(const igraph_vector_t *x, igraph_integer_t n,
...
igraph_error_t igraph_i_exact_coarse_graining(const igraph_real_t *v, igraph_integer_t *gr,
                                              igraph_integer_t n);
